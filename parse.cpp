...
namespace parse
{
    ...
    static ast::Statement parse_statement(token::Buffer& buffer);


    static std::ostream& operator <<(std::ostream& stream, StatementHandlerMap const& value)
    {
        token::TypeSet types;
    ...
    [[noreturn]]
    static void exception(std::string const& message, source::Location const& location)
    {
    ...
    [[noreturn]]
    static void expected_token_exception(ExpectedType expected, token::Token const& found)
    {
        std::stringstream message_stream;
    ...
    static token::Token expect_token(token::Buffer& buffer, token::Type expected)
    {
    ...
    static token::Token expect_one_of(token::Buffer& buffer)
    {
    ...
    static token::Token expect_identifier(token::Buffer& buffer)
    {
        return expect_token(buffer, token::Type::Identifier);
    }


    static token::Token expect_numeric_literal(token::Buffer& buffer)
    {
        return expect_one_of<token::Type::LiteralInt, token::Type::LiteralFloat>(buffer);
    }


    static void expect_as(token::Buffer& buffer)
    {
        expect_token(buffer, token::Type::KeywordAs);
    }


    static void expect_assign(token::Buffer& buffer)
    {
        expect_token(buffer, token::Type::SymbolAssign);
    }


    static void expect_to(token::Buffer& buffer)
    {
        expect_token(buffer, token::Type::KeywordTo);
    }


    static void expect_open_bracket(token::Buffer& buffer)
    {
        expect_token(buffer, token::Type::SymbolOpenBracket);
    }


    static void expect_close_bracket(token::Buffer& buffer)
    {
        expect_token(buffer, token::Type::SymbolCloseBracket);
    }


    static void expect_end_for(token::Buffer& buffer, token::Token const& start_token)
    {
    ...
    static token::OptionalToken optional_token(token::Buffer& buffer, token::Type type)
    {
    ...
    static bool found_optional_token(token::Buffer& buffer, token::Type type)
    {
        return optional_token(buffer, type).has_value();
    }


    static bool found_equal(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::SymbolEqual);
    }


    static bool found_while(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::KeywordWhile);
    }


    static bool found_step(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::KeywordStep);
    }


    static bool found_until(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::KeywordUntil);
    }


    static bool found_else(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::KeywordElse);
    }


    static bool found_case(token::Buffer& buffer)
    {
        return found_optional_token(buffer, token::Type::KeywordCase);
    }


    static ast::Expression parse_expression(token::Buffer& buffer, size_t precidence = 0)
    {
        return {};
    }


    static ast::ExpressionList parse_parameter_expressions(token::Buffer& buffer)
    {
        return {};
    }


    static ast::StatementBlock parse_block_body_for(token::Buffer& buffer,
    ...
    static ast::VaraibleDeclarationStatementPtr parse_variable_declaration(
                                                                          token::Buffer& buffer,
    ...
    static ast::VaraibleDeclarationList parse_parameter_declarations(
                                            token::Buffer& buffer,
    ...
    static ast::Statement parse_do_statement(token::Buffer& buffer, token::Token& do_token)
    {
    ...
    static ast::Statement parse_for_statement(token::Buffer& buffer, token::Token& for_token)
    {
    ...
    static ast::Statement parse_sub_statement(token::Buffer& buffer, token::Token& sub_token)
    {
    ...
    static ast::Statement parse_function_statement(token::Buffer& buffer,
    ...
    static ast::Statement parse_if_statement(token::Buffer& buffer, token::Token& if_token)
    {
    ...
    static ast::Statement parse_load_statement(token::Buffer& buffer, token::Token& load_token)
    {
        return std::make_unique<ast::LoadStatement>(load_token.location, expect_identifier(buffer));
    }


    static ast::Statement parse_loop_statement(token::Buffer& buffer, token::Token& loop_token)
    {
    ...
    static ast::Statement parse_select_statement(token::Buffer& buffer, token::Token& select_token)
    {
    ...
    static ast::Statement parse_structure_statement(token::Buffer& buffer,
    ...
    static ast::Statement parse_variable_declaration_statement(token::Buffer& buffer,
    ...
    static ast::Statement parse_identifier_statement(token::Buffer& buffer,
